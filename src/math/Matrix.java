...
public class Matrix implements Cloneable {
	...
	/**
	 * Transforms the given {@link Normal} using this {@link Matrix}.
	 * 
	 * @param normal
	 *            the {@link normal} to transform.
	 * @throws NullPointerException
	 *             when the given {@link normal} is null.
	 * @return the given {@link normal} transformed by this {@link Matrix}.
	 */
	public Normal transform(Normal normal) throws NullPointerException {
		double[] homogenous = normal.toHomogenousArray();
		double[] transformed = multiply(homogenous);
		return new Normal(transformed[0], transformed[1], transformed[2],
				transformed[3]);
	}
