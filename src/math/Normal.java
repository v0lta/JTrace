...
public class Normal implements Cloneable, Comparable<Normal> {
	/**
	 * x coordinate of this {@link Normal}.
	 */
	public final double x;

	/**
	 * y coordinate of this {@link Normal}.
	 */
	public final double y;

	/**
	 * z coordinate of this {@link Normal}.
	 */
	public final double z;

	/**
	 * Creates a {@link Normal} at the origin.
	 */
	public Normal() {
		this(0, 0, 0);
	}
	...
	/**
	 * Creates a new {@link Normal} at the given position.
	 * 
	 * @param x
	 *            the x coordinate.
	 * @param y
	...
	/**
	 * Creates a new {@link Normal} at the given position, scaled by the given
	 ...
	 */
	public Normal(double x, double y, double z, double w) {
		double inv_w = 1.0 / w;
		this.x = x * inv_w;
		this.y = y * inv_w;
		this.z = z * inv_w;
	 ...
	 */
	public Normal(Normal normal) throws NullPointerException {
	 ...
	 */
	public Normal add(double x, double y, double z) {
		return new Normal(this.x + x, this.y + y, this.z + z);
	}
	 ...
	 */
	public Normal add(Vector vector) throws NullPointerException {
	 ...
	 */
	public Vector subtract(Normal point) throws NullPointerException {
	 ...
	 *         coordinates divided by the given divisor.
	 */
	public Normal divide(double divisor) {
	 ...
	 *         axis.
	 */
	public Comparator<Normal> getComparator(final int axis)
			throws IllegalArgumentException {
		return new Comparator<Normal>() {
			@Override
